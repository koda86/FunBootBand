...
The `FunBootBand` library contains one function `band()`, which generates statistical (prediction or confidence) bands from curve data using a functional approach and bootstrapping. 
