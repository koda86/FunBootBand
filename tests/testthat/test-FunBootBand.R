...
# 0. Test if the function runs without error (assuming valid inputs)
...
# 1. Does the function output have a valid data type?
...
# 2. Does the function output have the correct length?
...
# 4. Test if the header is specified correctly
